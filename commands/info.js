...
exports.run = async (client, message, args) => {
    ...
    const embed = new RichEmbed()
        ...
        .addField("Website", "http://hyprdcbot.000webhostapp.com", true)
        .addField("Credits", "<@477814830598717441>") // Please don't remove these :3, if you do develop this further, just add your name on as a contributor.
